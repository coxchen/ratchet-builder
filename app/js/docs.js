$(function() {
  ...
  var calculateScroll = function() {
    ...
    if(pageHeight - currentTop < footerHeight + contentPadding + 900) {
      iphone[0].className = "iphone iphone-bottom";
      iphone[0].setAttribute('style','');
      console.log("# [1] " + pageHeight + " - " + currentTop + " < " + footerHeight + " + " + contentPadding + " + 1400");
      ...
      console.log("# [2] (" + iphone.initialTop + " - " + currentTop + ") <= " + iphone.dockingOffset);
    } else {
